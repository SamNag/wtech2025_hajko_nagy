...
<header class="px-4 pb-4 bg-transparent absolute top-0 left-0 w-full z-50 bg-transparent">
    <nav class="flex flex-grow justify-start md:justify-between items-center space-x-8 mt-4 ml-4">
        <a href="home.html" class="passion-one-bold animated-gradient text-4xl hidden md:flex">Flakes</a>
        <div class="hidden md:flex items-center space-x-8 text-blue-200">
            <a href="products.blade.php" class="inconsolata-regular hover:text-gray-100 text-xl">Products -</a>
            <a href="about.blade.php" class="inconsolata-regular hover:text-gray-100 text-xl">About -</a>
            <a href="contact.blade.php" class="inconsolata-regular hover:text-gray-100 text-xl">Contact -</a>
        </div>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col items-center p-4 md:p-0 mt-4 rounded-lg bg-black bg-opacity-50 backdrop-blur-sm md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
                    <li><a href="products.blade.php" class="block py-2 px-3 inconsolata-regular text-xl text-blue-200 hover:text-white">Products</a></li>
                    <li><a href="contact.blade.php" class="block py-2 px-3 inconsolata-regular text-xl text-blue-200 hover:text-white">Contact</a></li>
                    <li><a href="about.blade.php" class="block py-2 px-3 inconsolata-regular text-xl text-blue-200 hover:text-white">About</a></li>
                    <li><a href="login.blade.php" class="block py-2 px-3 inconsolata-regular text-xl text-blue-200 hover:text-white">Profile</a></li>
                    <li><a href="cart.blade.php" class="block py-2 px-3 inconsolata-regular text-xl text-blue-200 hover:text-white">Cart</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<p class="text-center text-3xl mt-20 inconsolata-bold pb-2  max-w-xl mx-auto">There's
    nothing here,
</p>
...
<footer class="bg-gray-200">
    <div class="container mx-auto px-4 py-8 flex flex-wrap justify-center items-center">
        <p class="w-full md:w-1/3 mb-8 lg:mb-0 text-gray-500 text-center hover:text-gray-700 block lg:inline">
            © 2025 Flakes
        </p>
    </div>
